...
const pool = mysql.createPool({
    host: 'database-1.cje2o4uu8cf0.us-east-1.rds.amazonaws.com',
    user: 'admin',
    password: 'admin123',
    database: 'T09_Energia',  // Especificar la base de datos aquí
...
app.post('/submit-form', (req, res) => {
    ...
    pool.getConnection((err, connection) => {
        ...
        connection.changeUser({ database: 'T09_Energia' }, (err) => {
            if (err) {
